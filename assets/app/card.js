...
// Zablokowane ładowanie obrazu
var imageReloadEvent = (image) => {
  console.log("Ładowanie obrazu zablokowane.");
  // setImage(image);  ← usunięte
};
...
// ❌ Funkcja setImage wyłączona (żeby zdjęcie się nie zmieniało)
function setImage(image) {
  console.log("setImage zablokowane – zdjęcie nie będzie ładowane.");
}

// Funkcja setData bez zmian (do pozostałych pól)
